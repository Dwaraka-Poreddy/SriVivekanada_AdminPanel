...
function Dashboard({ history }) {
  ...
  const HandleTextUpload = async (e) => {
    ...
    daty[0] = newText;
    await database.collection("Results_JnrClg").doc("Results_JnrClg").update(
      {
        texts_array: daty,
      },
      { merge: true }
                ...
                <Card sx={{ height: "100%" }}>
                  <MDBox padding="1rem">
                    ...
                    <MDBox pt={2} pb={1} px={1}>
                      ...
                      <Divider />
                      <center>
                        <Link to={`/exams_results_Junior_College`}>
                          <MDButton variant="gradient" color="primary">
                            &nbsp;Selected
                          </MDButton>
                        </Link>
                ...
                <Card sx={{ height: "100%" }}>
                  <MDBox padding="1rem">
                    ...
                    <MDBox pt={2} pb={1} px={1}>
                      ...
                      <Divider />
                      <center>
                        <Link to={`/exams_results_Degree_College`}>
                          <MDButton variant="gradient" color="primary">
                            &nbsp;Select
                          </MDButton>
                        </Link>
