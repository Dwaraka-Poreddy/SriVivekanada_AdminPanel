  ...
  useEffect(() => {
    const getContent = async () => {
      const snapshot = await database
        .collection("Activities_DegreeClg")
        .doc("Activities_DegreeClg")
        .get();
                ...
                <Card sx={{ height: "100%" }}>
                  <MDBox padding="1rem">
                    ...
                    <MDBox pt={2} pb={1} px={1}>
                      ...
                      <Divider />
                      <center>
                        <Link to={`/activities_Degree_College`}>
                          <MDButton variant="gradient" color="primary">
                            &nbsp;Selected
                          </MDButton>
                        </Link>
                ...
                <Card sx={{ height: "100%" }}>
                  <MDBox padding="1rem">
                    ...
                    <MDBox pt={2} pb={1} px={1}>
                      ...
                      <Divider />
                      <center>
                        <Link to={`/activities_Junior_College`}>
                          <MDButton variant="gradient" color="primary">
                            &nbsp;Select
                          </MDButton>
                        </Link>
